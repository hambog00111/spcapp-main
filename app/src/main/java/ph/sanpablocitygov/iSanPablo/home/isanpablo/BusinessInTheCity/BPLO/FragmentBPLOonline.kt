...
import ph.sanpablocitygov.iSanPablo.home.isanpablo.BusinessInTheCity.BPLO.Loginbplo.VolleySingleton1
import java.util.HashMap


class FragmentBPLOonline : Fragment(),View.OnClickListener {
