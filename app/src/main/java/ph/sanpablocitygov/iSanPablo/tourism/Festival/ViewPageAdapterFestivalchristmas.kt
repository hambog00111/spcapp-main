...
class ViewPageAdapterFestivalchristmas(private val context: Context) : PagerAdapter(){

    private var layoutInflater: LayoutInflater?=null
    private val images = arrayOf(R.drawable.christmas1,R.drawable.christmas2,R.drawable.christmas3)
