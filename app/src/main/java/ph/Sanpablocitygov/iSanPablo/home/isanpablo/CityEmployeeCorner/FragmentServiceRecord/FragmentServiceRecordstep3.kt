...
import kotlinx.android.synthetic.main.cec_service_record_fragment_requester_pic_with_id.*
import okhttp3.*
...
class FragmentServiceRecordstep3: Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? { val view = inflater.inflate(
        R.layout.cec_service_record_fragment_requester_pic_with_id, null)
...
//        val pic_with_id =view!!.findViewById<TextView>(R.id.pic_with_id).text.toString()
        ...
        val uornum=activity!!.intent.getStringExtra("ornum")
            ...
            override fun onResponse(call: Call, response: okhttp3.Response) {
                ...
                if (rptrequest.message== "Success" ) {
                    ...
                    activity!!.runOnUiThread(Runnable {
                        ...
                        dialogBuilder.setMessage("Request for Service Record successfully Sent.Please wait within 24 hrs and check your email for confirmation. Thank you!")
